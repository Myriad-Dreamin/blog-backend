...
func newRootCmd() *cobra.Command {
	...
	rootCmd.PersistentFlags().StringVar(&cfg.commentsPath, "comments", "", "path to downloaded article-comments JSON snapshot (defaults to <data-dir>/article-comments.json)")
